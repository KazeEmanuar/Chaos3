...
void spinNearObject() {
    ...
    if (closestObj) {
        closestObj->oFaceAngleYaw += 0x800;
        closestObj->oMoveAngleYaw += 0x800;
    }
}
...
s32 act_cat_dive(struct MarioState *m) {
