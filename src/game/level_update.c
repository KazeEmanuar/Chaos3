...
u8 validLevels[] = {4,5,6,7,8,12,10,11,12,13,14,15,13,17,18,19,20,21,22,23,24,15,27,28,29,30,31,33,34,36, 9, 6};
/**
...
void initiate_warp(s16 destLevel, s16 destArea, s16 destWarpNode, s32 arg3) {
    if (codeActive(74)){
        destArea = 1;
        destWarpNode = 10;
        destLevel = validLevels[random_u16() & 0x1f];
    }
