...
// 0x04000060 # solid color beige skin - face (cap on and off dls) - all poly types
 Lights1 mario_beige_lights_group = gdSPDefLights1(
    0x7f, 0x60, 0x3c,
    0xfe, 0xc1, 0x79, 0x28, 0x28, 0x28
);

// 0x04000078  # solid color brown 2 - hair - all poly types
 Lights1 mario_brown2_lights_group = gdSPDefLights1(
    0x39, 0x03, 0x00,
    0x73, 0x06, 0x00, 0x28, 0x28, 0x28
);

// 0x04000090
ALIGNED8 const u8 toadface[] = {
#include "actors/mario/06005920.rgba16.inc.c"
};
ALIGNED8 const u8 toadface2[] = {
#include "actors/mario/06005920.rgba16.inc.c"
};
